...
// 缩略图的支持
void CMFC7Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMFC7Doc::InitializeSearchContent()
{
...
void CMFC7Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
